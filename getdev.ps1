...
copy .\ui\IdentityServer4.Quickstart.UI.AspNetIdentity-dev\Quickstart\* Quickstart -recurse -force
copy .\ui\IdentityServer4.Quickstart.UI.AspNetIdentity-dev\Views\* Views -recurse -force
copy .\ui\IdentityServer4.Quickstart.UI.AspNetIdentity-dev\wwwroot\* wwwroot -recurse -force
